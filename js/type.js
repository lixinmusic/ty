     ...
     createScene:function(){
       var that=this;
         ...
         $("<div class='pass'>恭喜过关</div>").css({
          ...
          background:"#7ee1cd",fontSize:"30px",textAlign:"center",display:"none",borderRadius:"20px"
         }).appendTo(".scene")
         $("<div>下一关</div>").css({
          width:100,height:30,background:"#ffa5d8",margin:"30px auto",cursor:"pointer",fontSize:"16px",lineHeight:"30px",borderRadius:"10px"
